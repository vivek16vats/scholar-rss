...
fetch("scholar_complete.json")
  ...
  .then((data) => {
    ...
    initializeControls();
    renderCarousel();
    // Delay starting the infinite autoplay by 2 seconds on initial load
